	 getgenv().YUBUpdate = false
getgenv().updatedone = true





if getgenv().YUBUpdate == true and getgenv().updatedone == false  then
local Library = loadstring(game:HttpGet("https://pastebin.com/raw/GX28T0pH"))()
local Main = Library:CreateWindow("YUB update now")
...
if getgenv().updatedone == true then
    ...
    local openDBZ4 = Instance.new("ImageButton")
    local openDBZ3 = Instance.new("ImageButton")
    local openDBZ2 = Instance.new("ImageButton")
    local openDBZ1 = Instance.new("ImageButton")
...
openDBZ4.Position = UDim2.new(0.633917332, 0, 0.307386041, 0)
...
openDBZ3.Name = "open-DBZ3"
openDBZ3.Parent = InsertedObjects
openDBZ3.BackgroundTransparency = 1.000
openDBZ3.Position = UDim2.new(0.706711888, 0, 0.307386041, 0)
openDBZ3.Size = UDim2.new(0, 25, 0, 25)
openDBZ3.ZIndex = 2
openDBZ3.Image = "rbxassetid://3926307971"
openDBZ3.ImageRectOffset = Vector2.new(444, 204)
openDBZ3.ImageRectSize = Vector2.new(36, 36)
openDBZ3.Visible = false
openDBZ3.MouseButton1Up:Connect(function()
        openDBZ3.Visible = false
		DBZ3.Visible = true
...
openDBZ2.Name = "open-DBZ2"
openDBZ2.Parent = InsertedObjects
openDBZ2.BackgroundTransparency = 1.000
openDBZ2.Position = UDim2.new(0.785675526, 0, 0.307386041, 0)
openDBZ2.Size = UDim2.new(0, 25, 0, 25)
openDBZ2.ZIndex = 2
openDBZ2.Image = "rbxassetid://3926307971"
openDBZ2.ImageRectOffset = Vector2.new(444, 204)
openDBZ2.ImageRectSize = Vector2.new(36, 36)
openDBZ2.Visible = false
openDBZ2.MouseButton1Up:Connect(function()
	 openDBZ2.Visible = false 
		DBZ2.Visible = true
...
openDBZ1.Name = "open-DBZ1"
openDBZ1.Parent = InsertedObjects
openDBZ1.BackgroundTransparency = 1.000
openDBZ1.Position = UDim2.new(0.865256011, 0, 0.307386041, 0)
openDBZ1.Size = UDim2.new(0, 25, 0, 25)
openDBZ1.ZIndex = 2
openDBZ1.Image = "rbxassetid://3926307971"
openDBZ1.ImageRectOffset = Vector2.new(444, 204)
openDBZ1.ImageRectSize = Vector2.new(36, 36)
openDBZ1.Visible = false
openDBZ1.MouseButton1Up:Connect(function()
        openDBZ1.Visible = false 
		DBZ.Visible = true
end)
